VAR jonesLikes_Brigid = 2
VAR jonesLikes_Thomas = 0
VAR jonesLikes_Felixe = 2
VAR jonesLikes_Osbourne = 0
VAR jonesSuspicious_Brigid = 2
VAR jonesSuspicious_Thomas = 1
VAR jonesSuspicious_Osbourne = 1
VAR jonesSuspicious_Felixe = 1
VAR readContract = true
VAR jonesRide = "bike"
LIST jones_facts = brigid_hints
LIST brigid_facts = knows_jones_weird
VAR interrupt = true
VAR jonesSlaughter = 1
VAR knownames = true
...
= felixe
    ...
    *** "He seems cool. In a nerd sorta way[."]," you say with a grin. "I think we vibe on some of the same frequencies."
        "Should I be worried?"
        "What? No! You're my bestie for life!" you insist.
        Brigid rolls her eyes and smiles. "I was more meaning on if you've found a potential partner in chaos."
        You laugh. "We'll see!"
   ...
   -
    {jonesSuspicious_Felixe > 0:
        ...
        **[Continue]->
        ...
        "And that's... suspicious?" Brigid asks doubtfully.
        Now that you say it out loud, maybe it really <i>isn't</i> that weird.
            ...
            *** [Back down.]
              ...
              [Maybe it wasn't odd afterall...] #CLASS change
               ****[Talk about something else]
              ->keep_talking
        }
    *[Talk about something else]
...
= osbourne
 ...
 "That's one way to put it," you say with a laugh.
 ...
 *[Continue]->notsus
 ...
 =sus
    You think for a moment, then add, "I think maybe there's something shady going on with him."
    "Like with the syllabus?"
    "Yeah, that, but also... I mean, he kept looking at us weird? You, me and Felixe. He barely glanced at anyone else. <> {knownames:
    ...
    =notsus  
      "The syllabus thing is weird, but like we said before, that could be a wild coincidence."
        ...
        *[Continue]->os2
        =os2
        #CLEAR
    "What do you think of him? Do you like him? Or think he'll be a good teacher, at least."
...
=wait
    ...
    * "It is what it is[."]<>
        ...
        "Yeah, I guess there's no use dwelling on what you can't change," Brigid agrees, though she seems less sure about it than you.
    * "Actually, yeah!"
...
{jonesSharp > 0:
    ...
    Some phrases catch your attention this time, though. Things that don't make sense, but maybe that's just because you're not a lawyer. Maybe the whole "provide your replacement before you can leave" thing your dad was doing <i>was</i> legally enforceable.
    }
->opts
    

   = sign_your_life_away
 { read_contract : ->opts sign_for_real }  
